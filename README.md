            ...
            <div data-silex-id="silex-id-1440793860642-0" class="editable-style silex-id-1440793860642-0 text-element top-text" data-silex-type="text">
                <div class="silex-element-content normal">
                    <h1 style="text-align: center;" class="heading1">
                        <font color="#ffffff">Nikola</font>&nbsp;</h1>
                    <h1 style="text-align: center;" class="heading1">Markanovic</h1>
                    <div style="text-align: center;">
                        <h2 class="heading2">~CEO~</h2>
                    </div>
                </div>
            </div>
